...
I added the footnote numbers so I know it's complete and contiguous, and so do you: for example [10] is there as _not a link_ to mean that I haven't skipped it / forgot about it and there's another link leading to someplace.
...
Page 72:
Link in the book is broken (404), the correct link should be `https://smashed.by/privacyblueprint`, without the `s`
